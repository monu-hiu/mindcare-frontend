...
function Suggestions() {
  ...
  const podcasts = [
    ...
    { id: 107, category: "Motivation",     title: "Building Habits That Actually Stick",        host: "Nikhil Kamath",            youtubeId: "5k7sagWYWYA", desc: "Science-backed strategies on building lasting habits with discipline.",              color: "#f59e0b" },
  ...
  // ─────────────────────────────────────────────
  const videos = [
    { id: 201, category: "Depression",    title: "Depression — the secret we share",             host: "Andrew Solomon",           duration: "30 min", youtubeId: "-eBUcBfkVCo", color: "#3b82f6" },
    ...
    { id: 207, category: "Anxiety",       title: "Future of Mental Health — Anxiety",            host: "Tracy Dennis-Tiwary",      duration: "20 min", youtubeId: "GMnyt9wFyxA", color: "#8b5cf6" },
  ...
  return (
    <div className="sugPage">
      ...
      <div className="sugDropdownRow">
        ...
        {/* ── VOICE SEARCH ── */}
        <div className="sugSearchWrap">
          <label className="sugDropdownLabel">Search</label>
